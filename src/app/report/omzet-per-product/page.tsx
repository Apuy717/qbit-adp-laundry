...
export default function OmzetPerProduct() {
  ...
  const retrieveDataPerProduct = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_OMZET_PER_PRODUCT}`, {
        method: "POST",
...
// }, [startDate, endDate]);
  ...
  return (
    <main className="relative min-h-screen">
      ...
      <HeaderReport title="Report Merchant - Per Product" description=" Welcome to bossq merchant"/>
